    ...
    <? foreach ($arResult["ITEMS"] as $arItem): ?>
        ...
        <div class="photo" id="<?=$this->GetEditAreaId($arItem['ID']);?>" data-element-id="<?= $arItem['ID'] ?>">
            ...
            <div class="photo__info caption<?= $arItem["ID"] ?>">
                ...
                <div class="photo__info-rating <?=(IsMobileDevice())?"mobile-view":""?>">
                    <?
                    $APPLICATION->IncludeComponent('runetsoft:voting', ".default", array("ELEMENT_ID" => $arItem['ID'], "IBLOCK_ID" => $arParams['IBLOCK_ID'], "MAX_VALUE" => 10), $component);
                    ?>
