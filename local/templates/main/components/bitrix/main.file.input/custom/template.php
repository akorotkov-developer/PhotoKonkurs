...
?>
	...
	{
		?><div class="webform-field-upload d-none" id="mfi-<?=$arParams['CONTROL_ID']?>-button"><?
		...
		if (!empty($arParams["ALLOW_UPLOAD_EXT"]) || $arParams['MAX_FILE_SIZE'] > 0)
		{
			...
			?><div class="small form-text text-muted"><?=str_replace(array("#ext#", "#size#"), array(htmlspecialcharsBx($arParams["ALLOW_UPLOAD_EXT"]), CFile::FormatSize($arParams['MAX_FILE_SIZE'])), $message);?></div><?
		}
	}
?>
